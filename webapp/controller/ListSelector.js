sap.ui.define([
		...
		return BaseObject.extend("full.stack.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias full.stack.model.ListSelector
			 */
			 ...
			 * @return {full.stack.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
